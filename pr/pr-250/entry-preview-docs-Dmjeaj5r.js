...
var nativeObjectToString2 = objectProto2$1.toString;
...
var reIsNative = RegExp(
  "^" + funcToString2.call(hasOwnProperty$1).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
