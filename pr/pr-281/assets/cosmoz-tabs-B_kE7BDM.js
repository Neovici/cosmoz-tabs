import{i as e}from"./preload-helper-usAeo7Bx.js";import{K as t,U as n,q as r}from"./iframe-CQ_V4elZ.js";import{t as i}from"./cosmoz-tab-card-BHlXEMbY.js";import{C as a,_ as o,a as s,b as c,d as l,h as u,i as d,n as f,o as p,p as m,r as h,t as g,x as _,y as v}from"./if-defined-DkZmfCeb.js";import{a as y,i as b,n as x,o as S,r as C,s as w,t as T}from"./dist-DDJRhIJa.js";var E,D=e((()=>{s(),E=_(class extends c{update(){return this.state.host}})})),O,k,A,j=e((()=>{s(),D(),O=/([A-Z])/gu,k=(e,t,n)=>{e[t]=n,e.dispatchEvent(new CustomEvent(t.replace(O,`-$1`).toLowerCase()+`-changed`,{detail:{value:n}}))},A=(e,t,n=[t])=>{let r=E();v(()=>{k(r,e,t)},n)}})),M,N=e((()=>{j(),s(),M=e=>(v(()=>{e.dispatchEvent(new CustomEvent(`cosmoz-tab-alter`,{bubbles:!0,composed:!0}))},[e.hidden,e.disabled,e.heading,e.badge,e.icon]),A(`isSelected`,e.isSelected),{onSlot:u(({target:t})=>e.toggleAttribute(`has-cards`,t.assignedElements().some(e=>e.matches(`cosmoz-tab-card, [has-cards]`))),[])})})),P,F,I=e((()=>{h(),s(),i(),N(),P=a`
	:host {
		display: flex;
		position: relative;
