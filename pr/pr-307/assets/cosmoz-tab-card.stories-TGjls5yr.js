import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{c as t,s as n}from"./iframe-BME7UXCy.js";import{t as r}from"./cosmoz-tab-card-DuTiz3uA.js";import{a as i,c as a,n as o,s,t as c}from"./demo-content-DFEEuqpI.js";var l,u,d,f,p,m;function h(){return(h=e((()=>{t(),r(),i(),l={title:`Tabs/cosmoz-tab-card`,component:`cosmoz-tab-card`,tags:[`autodocs`],parameters:{docs:{description:{component:'A collapsible card, typically placed inside a `<cosmoz-tab>`. Its styling derives from `@neovici/cosmoz-tokens`, so it follows light/dark mode. Surface (`bg`, `border`, `radius`, `shadow`, `padding`, `margin`, `width`) and heading (`color`, `font-size`, `font-weight`, `line-height`) are all overridable via `--cosmoz-tab-card-*` custom properties — see the "Heading typography" story below.'}}}},u={parameters:{docs:{description:{story:`A static card, a collapsible card, and one that starts collapsed.`}}},render:()=>n`
    ...
    `},d={parameters:{docs:{description:{story:"The common pattern: cards tiled inside a tab panel (the tab gets a `has-cards` layout automatically)."}}},render:()=>n`
        ${a}
    ...
    `},f={parameters:{docs:{description:{story:"Without a `heading` the card is just a bordered content surface."}}},render:()=>n`
        ${a}
        <cosmoz-tab-card style="--cosmoz-tab-card-width: 420px;">
            ${s()}
        </cosmoz-tab-card>
    `},p={parameters:{docs:{description:{story:"The heading typography (`font-size`, `font-weight`, `line-height`) and `.header` row height are overridable via `--cosmoz-tab-card-heading-*` and `--cosmoz-tab-card-header-min-height` — on top of the existing `--cosmoz-tab-card-heading-color`. Defaults are unchanged, so this is opt-in. A common case is a compact section header (`--cz-text-sm` / `--cz-font-weight-medium`), shown here next to the default `--cz-text-lg` / semibold heading."}}},render:()=>n`
        ${a}
    ...
    `},m=[`Default`,`InsideTabs`,`WithoutHeading`,`HeadingTypography`],u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    ...
    \`
}`,...p.parameters?.docs?.source}}}})))()}h();export{u as Default,p as HeadingTypography,d as InsideTabs,f as WithoutHeading,m as __namedExportsOrder,l as default};