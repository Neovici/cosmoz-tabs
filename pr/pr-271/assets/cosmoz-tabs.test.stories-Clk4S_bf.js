import{i as e}from"./preload-helper-usAeo7Bx.js";import{K as t,q as n}from"./iframe-Dy5XTPV_.js";import{t as r,u as i}from"./untitled-BFOjbY5Y.js";import{t as a}from"./cosmoz-tabs-B22zm-qL.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{r(),n(),a(),{expect:o,fn:s,waitFor:c}=__STORYBOOK_MODULE_TEST__,l={title:`Tests/Tabs`},u=(e=`underline`)=>t`
...
}`,...b.parameters?.docs?.source}}},x=[`SelectsFirstAndSwitches`,`RendersBarFromChildren`,`HiddenAndDisabled`,`ClickSelects`,`FiresSelectEvents`,`DispatchesResizeOnSelect`,`NoResizeSuppressesResize`,`VariantBrandActiveStyling`,`VariantUnderlineActiveStyling`]}))();export{h as ClickSelects,_ as DispatchesResizeOnSelect,g as FiresSelectEvents,m as HiddenAndDisabled,v as NoResizeSuppressesResize,p as RendersBarFromChildren,f as SelectsFirstAndSwitches,y as VariantBrandActiveStyling,b as VariantUnderlineActiveStyling,x as __namedExportsOrder,l as default};