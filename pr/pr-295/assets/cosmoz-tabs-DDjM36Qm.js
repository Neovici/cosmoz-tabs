import{i as e}from"./preload-helper-usAeo7Bx.js";import{G as t,J as n,Y as r}from"./iframe-U3urd1-C.js";import{t as i}from"./cosmoz-tab-card-QFRbQPvv.js";import{B as a,C as o,G as s,H as c,I as l,J as u,K as d,M as f,S as p,T as m,W as h,v as ee,w as g,y as _}from"./untitled-CvpMlQeV.js";import{a as v,d as y,f as b,h as x,i as S,m as C,n as w,o as te,p as ne,r as T,s as E,t as D,u as O}from"./use-hash-param-CyoOV4J7.js";var k,A=e((()=>{g(),k=d(class extends s{update(){return this.state.host}})})),j,M,N,P=e((()=>{g(),A(),j=/([A-Z])/gu,M=(e,t,n)=>{e[t]=n,e.dispatchEvent(new CustomEvent(t.replace(j,`-$1`).toLowerCase()+`-changed`,{detail:{value:n}}))},N=(e,t,n=[t])=>{let r=k();h(()=>{M(r,e,t)},n)}})),F,I=e((()=>{P(),g(),F=e=>(h(()=>{e.dispatchEvent(new CustomEvent(`cosmoz-tab-alter`,{bubbles:!0,composed:!0}))},[e.hidden,e.disabled,e.heading,e.badge,e.icon]),N(`isSelected`,e.isSelected),{onSlot:a(({target:t})=>e.toggleAttribute(`has-cards`,t.assignedElements().some(e=>e.matches(`cosmoz-tab-card, [has-cards]`))),[])})})),L,R,z=e((()=>{p(),g(),i(),I(),L=u`
	:host {
		display: flex;
		position: relative;
