import{i as e}from"./preload-helper-usAeo7Bx.js";import{K as t,U as n,q as r}from"./iframe-FC_2RQow.js";import{t as i}from"./cosmoz-tab-card-CO6xkm5X.js";import{B as a,C as o,G as s,H as c,I as l,J as u,K as d,M as f,S as p,T as m,W as h,v as ee,w as g,y as _}from"./untitled-B6X5QwwM.js";import{a as v,d as y,f as b,g as x,h as S,i as C,m as te,n as w,o as T,p as E,r as D,s as O,t as k}from"./use-hash-param-Nxzt7yo5.js";var A,j=e((()=>{g(),A=d(class extends s{update(){return this.state.host}})})),M,N,P,F=e((()=>{g(),j(),M=/([A-Z])/gu,N=(e,t,n)=>{e[t]=n,e.dispatchEvent(new CustomEvent(t.replace(M,`-$1`).toLowerCase()+`-changed`,{detail:{value:n}}))},P=(e,t,n=[t])=>{let r=A();h(()=>{N(r,e,t)},n)}})),I,L=e((()=>{F(),g(),I=e=>(h(()=>{e.dispatchEvent(new CustomEvent(`cosmoz-tab-alter`,{bubbles:!0,composed:!0}))},[e.hidden,e.disabled,e.heading,e.badge,e.icon]),P(`isSelected`,e.isSelected),{onSlot:a(({target:t})=>e.toggleAttribute(`has-cards`,t.assignedElements().some(e=>e.matches(`cosmoz-tab-card, [has-cards]`))),[])})})),R,z,B=e((()=>{p(),g(),i(),L(),R=u`
	:host {
		display: flex;
		position: relative;
