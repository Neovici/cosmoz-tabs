import{i as e}from"./preload-helper-usAeo7Bx.js";import{K as t}from"./iframe-Bk-WGUUu.js";import{C as n,I as r,J as i,S as a,T as o,W as s,b as c,w as l,x as u}from"./untitled-BRe1fzFe.js";var d,f,p=e((()=>{d={duration:250},f=e=>(t,n,r)=>{let i=`max`+e.charAt(0).toUpperCase()+e.slice(1);Object.assign(t.style,{[i]:``,display:``,overflow:`hidden`});let{[e]:a}=t.getBoundingClientRect(),o=[0,a],[s,c]=n?o:o.slice().reverse(),l=t.animate([{[i]:`${s}px`},{[i]:`${c}px`}],{...d,...r});l.onfinish=()=>Object.assign(t.style,{[i]:``,display:n?``:`none`,overflow:n?``:`visible`})}})),m,h,g=e((()=>{p(),m=(e,t)=>{Object.assign(e.style,{display:t?``:`none`})},h=class extends HTMLElement{static get observedAttributes(){return[`opened`]}toggle=f(`height`);constructor(){super();let e=new CSSStyleSheet;e.replaceSync(`
      :host { display: block; }
		`);let t=this.attachShadow({mode:`open`});t.appendChild(document.createElement(`slot`)),t.adoptedStyleSheets=[e]}connectedCallback(){m(this,this.getAttribute(`opened`)!=null)}attributeChangedCallback(e,t,n){switch(e){case`opened`:{let e=n!=null;return this.isConnected?this.toggle(this,e):m(this,e)}}}},customElements.define(`cosmoz-collapse`,h)})),_=e((()=>{g(),p()})),v,y,b,x=e((()=>{_(),a(),l(),c(),v=()=>t`
	<svg
...
`,y=e=>{let{heading:n,collapsable:i,collapsed:a}=e,[o,c]=r(!!a),l=()=>{if(i)return c(e=>!e)};return s(()=>{e.toggleAttribute(`collapsed`,o)},[o]),t`${u(n,()=>t`<div class="header" part="header">
					${u(i,()=>t`
							<div
								@click=${l}
								class="collapse-icon"
						...
						`)}
					<h1 class="heading" @click=${l} part="heading">
...
`,customElements.define(`cosmoz-tab-card`,o(y,{observedAttributes:[`heading`,`collapsable`,`collapsed`],styleSheets:[n,b]}))}));export{x as t};