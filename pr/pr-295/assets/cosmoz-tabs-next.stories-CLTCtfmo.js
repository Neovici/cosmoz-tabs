import{i as e}from"./preload-helper-usAeo7Bx.js";import{G as t,J as n,Y as r}from"./iframe-DOneIXTJ.js";import{I as i,T as a,g as o,l as s,r as c,t as l,w as u}from"./untitled-tiq9wtpx.js";import{a as d,c as f,i as p,l as m,o as h,s as g,t as _}from"./demo-content-B_yrJEC6.js";import{a as v,i as y,r as b,t as x}from"./next-Da4QcpH0.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;e((()=>{l(),u(),r(),x(),d(),S={title:`Tabs/cosmoz-tabs-next`,component:`cosmoz-tabs-next`,tags:[`autodocs`],parameters:{docs:{description:{component:"Next, data-driven tabs. A `cosmoz-tab-next` is **only the clickable header** - it does not switch panels by itself. Selection is owned by the consumer: either wire `active` + a click handler yourself (the raw element API, used by most demos below), or use the `useTabs`/`renderTabs`/`renderActivated` hook API (see *Data driven*)."}},controls:{disable:!0}},argTypes:{variant:{control:`select`,options:[`underline`,`brand`],description:`Untitled UI tab style`,table:{defaultValue:{summary:`underline`}}}}},C={overview:g,rows:m,accounting:_,history:p},w=e=>{let t=e.getAttribute(`variant`)||`underline`,[r,a]=i(`overview`),o=e=>a(e.currentTarget.dataset.name);return n`
    ...
    `},customElements.get(`cosmoz-tabs-next-default-demo`)||customElements.define(`cosmoz-tabs-next-default-demo`,a(w,{observedAttributes:[`variant`]})),T={args:{variant:`underline`},parameters:{controls:{disable:!1},docs:{source:{code:`const [active, setActive] = useState('overview');
...
<div>\${panels[active]()}</div>`}}},render:({variant:e})=>n`<cosmoz-tabs-next-default-demo
        ...
        <div style="padding-top: 20px">${C[r]()}</div>
    `},customElements.get(`cosmoz-tabs-next-variants-bar`)||customElements.define(`cosmoz-tabs-next-variants-bar`,a(E,{observedAttributes:[`variant`]})),D={parameters:{docs:{source:{code:`const [active, setActive] = useState('overview');
const select = (e) => setActive(e.currentTarget.dataset.name);
    ...
    `},O=()=>{let[e,t]=i(`overview`),r=e=>t(e.currentTarget.dataset.name);return n`
        ...
        <cosmoz-tabs-next variant="brand">
            ...
            <cosmoz-tab-next
                ...
                @click=${r}
            >
                ${o({slot:`icon`})} Accounting
            </cosmoz-tab-next>
        </cosmoz-tabs-next>
        <div style="padding-top: 20px">${C[e]()}</div>
    `},customElements.get(`cosmoz-tabs-next-icons-demo`)||customElements.define(`cosmoz-tabs-next-icons-demo`,a(O)),k={parameters:{docs:{source:{code:`<cosmoz-tabs-next variant="brand">
  <cosmoz-tab-next data-name="overview"
    ...
    \${receiptIcon({ slot: 'icon' })} Overview
        ...
        <div style="padding-top: 20px">${C[e]()}</div>
    `},customElements.get(`cosmoz-tabs-next-states-demo`)||customElements.define(`cosmoz-tabs-next-states-demo`,a(A)),j={parameters:{docs:{source:{code:`const select = (e) => {
...
<cosmoz-tabs-next variant="underline">
  ...
  <cosmoz-tab-next data-name="history" hidden @click=\${select}>History</cosmoz-tab-next>
        ...
        <div style="padding-top: 20px">${C[e]()}</div>
    `},customElements.get(`cosmoz-tabs-next-compactwidth-demo`)||customElements.define(`cosmoz-tabs-next-compactwidth-demo`,a(M)),N={name:`Compact width`,parameters:{docs:{source:{code:`
...
\${renderActivated(model, (tab) =>
  tab.isActive ? tab.render() : nothing)}`},description:{story:'Bind selection to the URL by passing `{ hashParam }` to `useTabs` (here `useTabs(tabs, { hashParam: "ntab" })`) - deep-links and the back button work, just like the legacy family. Note: inside Storybook the visible address bar belongs to the **manager**, while the component binds to the **preview iframe** URL, so the change is not visible here. Open this story in a new tab / isolation mode to see the real URL change and the back button.'}}},render:()=>n`<cosmoz-tabs-next-hash-demo></cosmoz-tabs-next-hash-demo>`},R=e=>{let t=e.getAttribute(`vars`)||``,[r,a]=i(`overview`),o=e=>a(e.currentTarget.dataset.name);return n`
        ...
        <div style="padding-top: 20px">${C[r]()}</div>
    `},customElements.get(`cosmoz-tabs-next-colors-bar`)||customElements.define(`cosmoz-tabs-next-colors-bar`,a(R,{observedAttributes:[`vars`]})),z={parameters:{docs:{source:{code:`
<cosmoz-tabs-next
  variant="brand"
...
>
  <cosmoz-tab-next data-name="overview"
    ...
    `},B=()=>{let[e,t]=i(`overview`),r=e=>t(e.currentTarget.dataset.name);return n`
        ...
        <div style="padding-top: 20px">${C[e]()}</div>
    `},customElements.get(`cosmoz-tabs-next-minimal-demo`)||customElements.define(`cosmoz-tabs-next-minimal-demo`,a(B)),V={parameters:{docs:{source:{code:`<cosmoz-tabs-next
  variant="brand"
...
}`,...G.parameters?.docs?.source}}},K=[`Default`,`Variants`,`WithIcons`,`DisabledAndHidden`,`CompactWidth`,`DataDriven`,`HashRouting`,`SelectedColors`,`Minimal`,`Theming`,`Overflow`]}))();export{N as CompactWidth,F as DataDriven,T as Default,j as DisabledAndHidden,L as HashRouting,V as Minimal,G as Overflow,z as SelectedColors,H as Theming,D as Variants,k as WithIcons,K as __namedExportsOrder,S as default};