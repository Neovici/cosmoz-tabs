...
import './cosmoz-tabs-iKw8h9KL.js';
...
const basics = () => x`
	<cosmoz-tabs selected="tab3">
		...
		<cosmoz-tab
			...
			selected-icon="icons:check-box"
		>
			<p>
				Fusce consectetur nisi at felis finibus rutrum. Vestibulum fermentum
				pharetra sem, vitae tincidunt est mattis tristique. Donec blandit nulla
				non tellus tincidunt pretium. Phasellus et purus id dolor venenatis
				mollis.
			</p>
		</cosmoz-tab>
		<cosmoz-tab heading="Tab3" name="tab3" badge="3" hidden>
			<p>
				...
				Vestibulum accumsan, sapien eu gravida consectetur, purus felis lobortis
				massa, id consequat eros lacus sit amet quam. Nunc bibendum elit turpis.
			</p>
		</cosmoz-tab>
		<cosmoz-tab heading="Tab4" name="tab4" badge="4">
			<p>
				Sed pretium a felis sed dictum. Vestibulum ornare quam in metus vehicula
				consectetur. Proin faucibus ac sapien vel bibendum. Quisque molestie
				cursus lacus. Maecenas sit amet finibus diam, eget finibus nisi. Integer
				eget laoreet metus. Fusce quis molestie massa.
			</p>
		</cosmoz-tab>
...
export { __namedExportsOrder, basics, cosmozTab_stories as default };
